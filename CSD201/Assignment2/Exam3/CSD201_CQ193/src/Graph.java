...
public class Graph {
    ...
    void pathDijkstra(int[] dist, int[] path, int p, int q,
        ...
        while (!s.isEmpty()) {
            q = s.pop();
            fvisit(q, f);
            shortestDistance = dist[q];
        }
        f.writeBytes("\r\n");
        f.writeBytes("  " + Integer.toString(shortestDistance));
        f.writeBytes("\r\n");
    }
    ...
    void f1() throws Exception {
         ...
         * Starting from the vertex D (which index is 3), ONLY display the
         * vertex D and the next 3 vertices. Hint: copy breadth(...) to
         * bfsTraversal(...) and modify the method bfsTraversal(...)
         * appropriately. The output f1() will be written into file 'f1.txt'.
         ...
         * 'f1.txt' after running this method is: D A G B C E F H I D A G B
         */
        //-------------------------------------------------------------------
        //------ Start your code here----------------------------------------
    ...
    void f2() throws Exception {
         ...
         * the vertex right after B and the next 3 vertices. Hint: use and
         * modify dfsTraversal(...), dfsTraversal_rec(...) (provided in this
         * class) appropriately, then call dfsTraversal(...) in f2(). The output
         * f2() will be written into the file 'f2.txt'. Therefore you should
         * open this file to see/test your code output. Example: With the graph
         * provided in 'data1.txt', the content of 'f2.txt' after running this
         * method is: B A C F H E I D G A C F H
         */
        //-------------------------------------------------------------------
        //------ Start your code here----------------------------------------
        dfsTraversal(1, f);
    ...
    void f3() throws Exception {
         ...
         * the graph. You are given a solution to solve the Hamilton cycle
         * problem using Backtracking. It mainly uses hamCycleUtil(...) to solve
         * the problem (it returns false if there is no Hamilton cycle,
         * otherwise return true ...). Your task: Complete the missing code in
         * hamCycle(...) to print out the solution found with the graph G (given
         * in the data2.txt file). Hint: Use the fvisit(...) given in this class
         * to print out the solution. The output f3() will be written into the
         * file 'f3.txt'. Therefore you should open this file to see/test your
         * code output. Example: With the graph provided in 'data2.txt', the
         * content of 'f3.txt' after running this method is: A B C E D A
         */
        //-------------------------------------------------------------------
        //------ Start your code here----------------------------------------
    ...
    void f4() throws Exception {
         ...
         * the vertex D is 3), then write 3 lines to the file f4.txt: (1) Line
         * 1: contains vertices selected into the set S until the vertex D is
         * selected. (2) Line 2: contains vertices in shortest path from A to D,
         * and (3) Line 3: contains the shortest distance. Hint: use and modify
         * dijkstra(...), dijkstra2(...), pathDijkstra(...), fvisit(...),
         * fvisit2(...), fvisit3(...) (provided in this class) appropriately,
         * then call dijkstra(...) in f4(). The output f4() will be written into
         ...
         * the content of 'f4.txt' after running these methods is: A B C E F D A
         * C D 22
         */
        //-------------------------------------------------------------------
        //------ Start your code here----------------------------------------
